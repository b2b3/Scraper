# Hecho por @hazeactivo
# Mejorado con continuidad, palabras clave y mejor manejo de errores
import csv
import requests
...
if __name__ == "__main__":
    import json
    print("")
    print("Hola edd dblake! Elige que scraper ejecutar:")
    print("")
    ...
    try:
        if opcion == "1":
            ...
            print("")
            print("Opcion no valida edd dblake. Por favor ejecuta el script de nuevo y elige 1, 2 o 3.")
